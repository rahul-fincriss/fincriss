...
const mockNarrativesByCase: Record<string, Record<STRSectionType, string[]>> = {
  // ===========================================================================
  // USE CASE 2: INVESTMENT FRAUD / PONZI SCHEME - Dr. Ravi Gopal Kumar
  // ===========================================================================
  'CASE-PONZI-2025-001': {
    grounds_of_suspicion: [
      'The subject account, held by Dr. Ravi Gopal Kumar (Customer ID: CUS-DRK-3401), a 50-year-old cardiologist residing in Worli, Mumbai, has exhibited transaction patterns strongly indicative of an Investment Fraud / Ponzi Scheme. The account holder has declared monthly income of ₹4,00,000 from medical practice.',
      'Between 5th July 2025 and 27th July 2025, the subject\'s personal savings account (A/c: 50100XXXXX) received ₹1,50,00,000 (1.5 Crore) through 12 RTGS/NEFT transfers from unrelated third-party individuals across India. Transaction memos referenced "Fund Commitment", "Seed Capital", and "Investment Capital" - terminology inconsistent with medical practice income.',
      'Within 72 hours of final inflow aggregation, the entire ₹1.5 Crore was transferred to R.K. Health Investment LLP (A/c: 7000XXXXXX), a related party entity where Dr. Kumar is the authorized signatory. The LLP\'s declared business activity is "Consulting" which provides no legitimate basis for receiving investment capital.',
      'Subsequently, cyclical payments labeled "Quarterly Profit Share" were disbursed back to original remitters (investors) on approximately 45-day cycles, with individual payouts ranging from ₹12,00,000 to ₹25,00,000. This pattern is characteristic of Ponzi scheme operations where returns to early investors are funded by capital from subsequent investors.',
    ],
    transaction_narrative: [
      'Transaction flow analysis reveals a classic Investment Fraud / Ponzi Scheme pattern consisting of three distinct phases: (1) Placement via high-value inflows from multiple "investors", (2) Layering through rapid transfer to related party entity, and (3) Integration via cyclical payouts and luxury asset acquisition.',
      'PLACEMENT PHASE (July 2025):\nInbound RTGS/NEFT transfers totaling ₹1,50,00,000 from 12 unrelated individuals:\n- 05-Jul-2025: ₹15,00,000 from Sanjay Mehta (Mumbai) - "Fund Commitment"\n- 07-Jul-2025: ₹20,00,000 from Kavita Agarwal (Delhi) - "Seed Capital"\n- 09-Jul-2025: ₹12,00,000 from Ramesh Choudhary (Pune) - "Investment Commitment"\n- 11-Jul-2025: ₹8,00,000 from Pradeep Saxena (Ahmedabad) - "Fund Commitment"\n- 13-Jul-2025: ₹18,00,000 from Meera Nair (Bengaluru) - "Capital Investment"\n- 15-Jul-2025: ₹10,00,000 from Vikram Joshi (Hyderabad) - "Seed Capital"\n- 17-Jul-2025: ₹5,00,000 from Anita Deshmukh (Nashik) - "Fund Commitment"\n- 19-Jul-2025: ₹15,00,000 from Rajendra Pillai (Chennai) - "Investment Capital"\n- 21-Jul-2025: ₹12,00,000 from Sunil Kapoor (Kolkata) - "Fund Commitment"\n- 23-Jul-2025: ₹7,00,000 from Deepa Sharma (Jaipur) - "Seed Capital"\n- 25-Jul-2025: ₹13,00,000 from Arun Gupta (Lucknow) - "Capital Investment"\n- 27-Jul-2025: ₹15,00,000 from Neelam Reddy (Indore) - "Fund Commitment"',
      'LAYERING PHASE (July 2025):\n- 29-Jul-2025: ₹1,50,00,000 internal transfer from personal savings to R.K. Health Investment LLP\n- Purpose stated: "Capital transfer / Business funding"\n- Time from last inflow: <72 hours\n- Recipient entity controlled by same individual (Dr. Ravi Kumar as authorized signatory)',
      'INTEGRATION PHASE (September-November 2025):\nCyclical "Profit Share" disbursements back to original investors:\n- 15-Sep-2025: ₹25,00,000 to Sanjay Mehta - "Quarterly Profit Share"\n- 17-Sep-2025: ₹25,00,000 to Kavita Agarwal - "Quarterly Profit Share"\n- 19-Sep-2025: ₹25,00,000 to Meera Nair - "Quarterly Profit Share"\n- 01-Nov-2025: ₹18,00,000 to Ramesh Choudhary - "Profit Distribution"\n- 03-Nov-2025: ₹12,00,000 to Rajendra Pillai - "Profit Distribution"\n- 05-Nov-2025: ₹15,00,000 to Sunil Kapoor - "Quarterly Profit Share"\n\nLuxury Asset Acquisition:\n- 25-Oct-2025: ₹50,00,000 to Goa Seaside Properties Pvt Ltd\n- Purpose: "Commercial Real Estate Purchase" - Luxury villa in Goa\n- Source: Business LLP account (personal benefit from investor funds)',
    ],
    customer_background: [
      'Dr. Ravi Gopal Kumar (PAN: ABCD1234F) is a 50-year-old individual customer, onboarded on 15th February 2021. His KYC profile indicates: Occupation: Cardiologist (Medical Professional); Declared Monthly Income: ₹4,00,000; Source of Wealth: Medical Practice Income; Source of Funds: Professional Fees / Salary; Expected Annual Turnover: ₹40,00,000 - ₹60,00,000.',
      'The customer maintains two accounts: (1) Personal Savings Account (A/c: 50100XXXXX) at Mumbai branch, and (2) Business Current Account (A/c: 7000XXXXXX) linked to R.K. Health Investment LLP where Dr. Kumar is the sole authorized signatory. Pre-alert risk rating was Medium based on high net worth individual status. PEP and Sanctions screening: Clear.',
      'R.K. Health Investment LLP is registered with declared business activity as "Consulting". No evidence of any SEBI registration was found for any investment scheme operated by Dr. Kumar or the LLP. The entity structure appears designed to receive and redistribute funds under the guise of legitimate business operations.',
      'The severe mismatch between the customer\'s medical professional profile and the investment scheme-related transaction patterns (collecting "seed capital" from unrelated parties, cyclical "profit share" payouts) raises significant concern about operation of an unregistered collective investment scheme or Ponzi operation.',
    ],
    supporting_indicators: [
      'FinCrisS Priority Rating: HIGH (Score: 94/100)\n\nRisk Indicators Identified:\n1. Investment Fraud / Ponzi Scheme typology match (High Confidence)\n2. High-value RTGS/NEFT inflows from 12 unrelated "investors" totaling ₹1.5 Crore\n3. Transaction memos indicate investment scheme: "Fund Commitment", "Seed Capital", "Capital Investment"\n4. Rapid layering via internal transfer to related party LLP within 72 hours\n5. Cyclical reciprocal "Quarterly Profit Share" payments to original investors on 45-day cycles\n6. ₹50L luxury real estate purchase in Goa - integration/personal benefit',
      'Behavioral Anomaly Indicators:\n- LLP declared as "Consulting" firm but receiving "investment capital"\n- No SEBI registration for any collective investment scheme\n- Payout schedule (45-day cycle) does not align with any legitimate investment instrument\n- Payments to investors funded from subsequent investor inflows (classic pyramid pattern)\n- Personal luxury asset acquisition funded via business entity\n\nTypology Classification: Investment Fraud / Ponzi Scheme\nRecommendation: File STR with FIU-IND under Section 12 of PMLA, 2002. Consider referral to SEBI and ED for potential PFUTP and PMLA violations.',
    ],
  },
  // ===========================================================================
