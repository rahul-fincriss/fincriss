              ...
              <div className="mt-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedTransaction.amount > 9000 && (
                      <Badge className="badge-risk-medium">Near Threshold</Badge>
                    )}
                    {['VG', 'PA', 'CY'].includes(selectedTransaction.country) && (
                      <Badge className="badge-risk-high">High-Risk Jurisdiction</Badge>
                    )}
                    {selectedTransaction.channel === 'Wire' && (
