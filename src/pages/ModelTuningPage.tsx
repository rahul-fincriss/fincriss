        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">
              Experimental & Governance Workspace
            </span>
          </div>
        </div>
      ...
      <Tabs defaultValue="models" className="space-y-6">
        ...
        <TabsContent value="models" className="space-y-6">
              ...
              <Table>
                ...
                <TableBody>
                  {availableModels.map((model) => (
                    <TableRow 
                      key={model.id}
                      className={activeModel === model.id ? 'bg-primary/5' : ''}
                    >
                      <TableCell>
                        <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor for distribution shifts that may affect model performance
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {driftIndicators.map((indicator) => (
                  ...
                  >
                    <div>
                      ...
                      <p className={`text-xs ${
                        indicator.status === 'stable' ? 'text-status-success' :
        ...
        <TabsContent value="performance" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Historical accuracy and false positive rates over time
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="tuning" className="space-y-6">
          <Alert className="border-status-info/30 bg-status-info/10">
            ...
            <AlertDescription className="text-muted-foreground">
              Parameter adjustments will be tested in shadow mode before production deployment. 
              All changes are subject to compliance review and audit logging.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enable or disable specific detection capabilities
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Identify potential transaction splitting patterns
                    </p>
                  </div>
                  <Switch
                    id="structuring"
                ...
                <div className="pt-4 border-t">
                  ...
                  <div className="flex items-center justify-between text-sm mt-2">
                    ...
                    <span>James Patterson (Super Admin)</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Recent parameter modifications and their review status
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
